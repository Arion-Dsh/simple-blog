...
func AdminNovels(c echo.Context) error {
	cc := c.(*CustomContext)
...
//AdminNovelEdit ...
func AdminNovelEdit(c echo.Context) error {
	cc := c.(*CustomContext)
...
//AdminNovel ...
func AdminNovel(c echo.Context) error {
	cc := c.(*CustomContext)
...
//AdminChapters ...
func AdminChapters(c echo.Context) error {
	cc := c.(*CustomContext)
...
//AdminChapter ...
func AdminChapter(c echo.Context) error {
	cc := c.(*CustomContext)
...
//AdminChapterEdit ...
func AdminChapterEdit(c echo.Context) error {
	cc := c.(*CustomContext)
	...
	return cc.Redirect(http.StatusSeeOther, cc.Echo().Reverse("admin_chapters", nName))
}
